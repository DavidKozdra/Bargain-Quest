...
class DiplomacySystem {
  static PACTS = {
    trade_pact:  { name: "Trade Pact",  emoji: "🤝", desc: "Reduced tariffs, +15% route income with this city.", duration: 30 },
    alliance:    { name: "Alliance",    emoji: "🛡️", desc: "Shared defense. Allied cities help fight raiders.", duration: 50 },
    rivalry:     { name: "Rivalry",     emoji: "⚔️", desc: "Price war. Both cities suffer trade penalties.", duration: 20 },
    embargo:     { name: "Embargo",     emoji: "🚫", desc: "Block all trade routes with this city.", duration: 15 },
  };
