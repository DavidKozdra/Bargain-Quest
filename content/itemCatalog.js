...
function _bqItemFactoryLib() {
  ...
  return window.KozEngine?.Items?.itemFactory || null;
}
...
class Item {
  ...
  getValue(modifiers = {}) {
    const itemFactory = _bqItemFactoryLib();
    if (itemFactory && typeof itemFactory.calculateItemValue === "function") {
      return itemFactory.calculateItemValue(
        this,
        modifiers,
...
(function exportItemCatalog(root) {
  ...
  if (typeof root.ITEM_ICONS === "undefined") root.ITEM_ICONS = ITEM_ICONS;
  if (typeof root.createItemIconEl !== "function") root.createItemIconEl = createItemIconEl;
